...
// function checkForGoal(rules) {
//     for(let rule of rules) {
//         rule = rule.toLowerCase();
//         if(rule.indexOf('goal') > -1) {
//             return true;
//         }
//     }
// }
...
// function checkForGoal(ruleTokenMatrix) {
//     for(let ruleTokens of ruleTokenMatrix) {
//         for(let token of ruleTokens) {
//             if(token.type === 'fact') {
//                 let tokenValue = token.value.toLowerCase();
